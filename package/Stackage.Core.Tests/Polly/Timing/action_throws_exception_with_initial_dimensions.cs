...
{
   public class action_throws_exception_with_initial_dimensions
   {
      ...
      public async Task setup_scenario()
      {
         ...
         var timingPolicy = policyFactory.CreateAsyncTimingPolicy("bar", _metricSink, new Dictionary<string, object> {{"initial-key", "initial-value"}});
