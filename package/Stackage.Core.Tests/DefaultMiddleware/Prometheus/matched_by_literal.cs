...
{
   public class matched_by_literal : middleware_scenario
   {
      ...
      public async Task setup_scenario()
      {
         ...
         {
            await TestService.GetAsync(server, "/replace-this");
      ...
      public void should_return_start_metric()
      {
         ...
         lines.ShouldContain("http_request_start{method=\"GET\",path=\"with-this\"} 1");
      }
