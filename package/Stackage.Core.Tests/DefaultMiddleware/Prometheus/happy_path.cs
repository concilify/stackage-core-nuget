...
{
   public class happy_path : middleware_scenario
   {
      ...
      public async Task setup_scenario()
      {
         ...
         {
            var r = await TestService.GetAsync(server, "/foo/bar/get");
      ...
      public void should_return_start_metric()
      {
         ...
         lines.ShouldContain("http_request_start{method=\"GET\",path=\"/foo/bar/get\"} 1");
      }
      ...
      public void should_return_end_metric()
      {
         ...
         lines.ShouldContain("http_request_end_bucket{method=\"GET\",path=\"/foo/bar/get\",statusCode=\"200\",le=\"10000\"} 1");
      }
