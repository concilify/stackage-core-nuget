...
namespace Stackage.Core.Middleware
{
   ...
   public class TimingAndExceptionHandlingMiddleware
   {
      private readonly RequestDelegate _next;
      private readonly IPolicyFactory _policyFactory;
      private readonly IMetricSink _metricSink;
      private readonly IGuidGenerator _guidGenerator;
      private readonly ILogger<TimingAndExceptionHandlingMiddleware> _logger;

      public TimingAndExceptionHandlingMiddleware(
         RequestDelegate next,
         IPolicyFactory policyFactory,
         IMetricSink metricSink,
         IGuidGenerator guidGenerator,
         ILogger<TimingAndExceptionHandlingMiddleware> logger)
      {
      ...
      public async Task Invoke(HttpContext httpContext)
      {
         ...
         await timingPolicy.ExecuteAsync(policyContext => Invoke(httpContext, policyContext), dimensions);
      }
